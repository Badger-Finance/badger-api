...
exports.getPriceSnapshotsAtTimestamps =
  exports.fetchPrices =
  exports.convert =
  exports.getPrice =
  exports.updatePrice =
...
async function updatePrice({ address, price }) {
  try {
    ...
    return mapper.put(
      Object.assign(new token_price_snapshot_model_1.TokenPriceSnapshot(), {
...
async function getPrice(address, currency) {
  try {
    ...
    for await (const item of mapper.query(
      token_price_snapshot_model_1.TokenPriceSnapshot,
      { address: ethers_1.ethers.utils.getAddress(address) },
  ...
  try {
    ...
    for (const timestamp of timestamps) {
      for await (const snapshot of mapper.query(
        ...
        {
          address: ethers_1.ethers.utils.getAddress(address),
          updatedAt: (0, dynamodb_expressions_1.greaterThanOrEqualTo)(timestamp)
        },
        { limit: 1 }
      )) {
