...
describe("accounts.utils", () => {
  ...
  describe("getAccounts", () => {
    describe("users exist", () => {
      it("returns a list of user accounts", async () => {
        ...
        let responded = false;
        jest
          .spyOn(chain_config_1.Chain.prototype, "getSdk")
          .mockImplementation(async () => tests_utils_1.TEST_CHAIN.sdk);
  ...
  describe("getLatestMetadata", () => {
    ...
    it("should create new meta if no meta obj found", async () => {
      ...
      jest
        .spyOn(tests_utils_1.TEST_CHAIN.provider, "getBlockNumber")
