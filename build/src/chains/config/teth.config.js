...
const loadTokens_json_1 = tslib_1.__importDefault(require("@badger-dao/sdk-mocks/generated/ethereum/api/loadTokens.json"));
...
class TestEthereum extends chain_config_1.Chain {
    constructor(provider) {
        super(sdk_1.Network.Ethereum, loadTokens_json_1.default, provider, new test_strategy_1.TestStrategy(), '0x31825c0a6278b89338970e3eb979b05b27faa263');
