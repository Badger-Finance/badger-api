...
class Fantom extends chain_config_1.Chain {
  constructor() {
    super(
      sdk_1.Network.Fantom,
      fantom_tokens_config_1.fantomTokensConfig,
      rpc_config_1.default[sdk_1.Network.Fantom],
      new base_strategy_1.BaseStrategy(sdk_1.Network.Fantom, Object.keys(fantom_tokens_config_1.fantomTokensConfig)),
