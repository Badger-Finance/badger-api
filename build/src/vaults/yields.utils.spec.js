...
describe('yields.utils', () => {
    const baseMockSources = [
        (0, yields_utils_1.createYieldSource)(constants_1.MOCK_VAULT_DEFINITION, source_type_enum_1.SourceType.PreCompound, vaults_utils_1.VAULT_SOURCE, 7),
        (0, yields_utils_1.createYieldSource)(constants_1.MOCK_VAULT_DEFINITION, source_type_enum_1.SourceType.Compound, vaults_utils_1.VAULT_SOURCE, 11),
        (0, yields_utils_1.createYieldSource)(constants_1.MOCK_VAULT_DEFINITION, source_type_enum_1.SourceType.TradeFee, 'LP Fees', 2),
        (0, yields_utils_1.createYieldSource)(constants_1.MOCK_VAULT_DEFINITION, source_type_enum_1.SourceType.Emission, 'Badger', 4),
        (0, yields_utils_1.createYieldSource)(constants_1.MOCK_VAULT_DEFINITION, source_type_enum_1.SourceType.Emission, 'Boosted Badger', 6, { min: 0.5, max: 2 }),
        (0, yields_utils_1.createYieldSource)(constants_1.MOCK_VAULT_DEFINITION, source_type_enum_1.SourceType.Flywheel, 'Vault Flywheel', 5),
        (0, yields_utils_1.createYieldSource)(constants_1.MOCK_VAULT_DEFINITION, source_type_enum_1.SourceType.Distribution, 'Badger', 3),
        (0, yields_utils_1.createYieldSource)(constants_1.MOCK_VAULT_DEFINITION, source_type_enum_1.SourceType.Distribution, 'Irrelevant', 0.0001),
    ];
    describe('calculateYield', () => {
        ...
        it('throws an error when provided with invalid principal and compounding pair', () => {
            expect(() => (0, yields_utils_1.calculateYield)(365, 1, sdk_1.ONE_DAY_MS, 2)).toThrow('Compounding value must be less than or equal to earned');
        });
    });
    describe('calculateBalanceDifference', () => {
        it('returns an array with the difference in token amounts', () => {
            ...
            expect((0, yields_utils_1.calculateBalanceDifference)(listA, listB)).toMatchObject([(0, tokens_utils_1.mockBalance)(badger, 15), (0, tokens_utils_1.mockBalance)(wbtc, 3)]);
        });
    });
