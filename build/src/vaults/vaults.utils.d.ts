...
export declare function getCachedVault(chain: Chain, vaultDefinition: VaultDefinitionModel, currency?: Currency): Promise<VaultDTO>;
 ...
 */
export declare function estimateDerivativeEmission(compoundApr: number, emissionApr: number, emissionCompoundApr: number, compoundingStep?: number, emissionStep?: number): number;
export declare function loadVaultGraphPerformances(chain: Chain, vault: VaultDefinitionModel): Promise<YieldSource[]>;
export declare function estimateHarvestEventApr(chain: Chain, token: VaultPerformanceEvent['token'], start: number, end: number, amount: VaultPerformanceEvent['amount'], balance: BigNumber): Promise<number>;
export declare function estimateVaultPerformance(chain: Chain, vault: VaultDefinitionModel, data: VaultHarvestData[]): Promise<YieldSource[]>;
...
export declare function getVaultHarvestsOnChain(chain: Chain, address: VaultDefinitionModel['address'], startFromBlock?: Nullable<number>): Promise<VaultHarvestsExtendedResp[]>;
