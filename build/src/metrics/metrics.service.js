...
let MetricsService = class MetricsService {
    async getProtocolMetrics() {
        ...
        let result;
        try {
            for await (const metric of mapper.query(protocol_metric_snapshot_model_1.ProtocolMetricSnapshot, { type: metric_type_1.MetricType.protocol }, { scanIndexForward: false, limit: 1 })) {
                result = metric;
            }
        }
        catch (error) {
