...
tslib_1.__decorate([
    (0, common_1.Inject)(),
    tslib_1.__metadata("design:type", metrics_service_1.MetricsService)
...
tslib_1.__decorate([
    ...
    (0, schema_1.Description)('Returns the total amount of users, total amount of vaults and total value locked across all chains'),
...
], MetricsController.prototype, "getProtocolMetrics", null);
