...
exports.getChainMetrics =
  exports.getProtocolSettMetrics =
  exports.getProtocolTotalUsers =
  exports.getProtocolMetrics =
    void 0;
...
async function getProtocolTotalUsers() {
  const usersAcrossChains = await Promise.all(
    chain_1.SUPPORTED_CHAINS.map((chain) => (0, accounts_utils_1.getAccounts)(chain))
  );
...
async function getProtocolSettMetrics() {
  ...
  for (const protocolSummary of multichainsSummary) {
    ...
    totalVaults +=
      (_b = (_a = protocolSummary.setts) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0
        ? _b
        : 0;
  }
