...
export declare type TokenBoostedEmissionChangedEvent = TypedEvent<[string, BigNumber], {
    _vault: string;
    _weight: BigNumber;
}>;
export declare type TokenBoostedEmissionChangedEventFilter = TypedEventFilter<TokenBoostedEmissionChangedEvent>;
export declare type TokenWeightChangedEvent = TypedEvent<[string, BigNumber], {
    _token: string;
    _weight: BigNumber;
}>;
...
export interface EmissionControl extends BaseContract {
    ...
    functions: {
        ...
        addManager(_manager: string, overrides?: Overrides & {
        ...
        removeManager(_manager: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setBoostedEmission(_vault: string, _weight: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setTokenWeight(_token: string, _weight: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    filters: {
        ...
        'TokenBoostedEmissionChanged(address,uint256)'(_vault?: string | null, _weight?: BigNumberish | null): TokenBoostedEmissionChangedEventFilter;
        TokenBoostedEmissionChanged(_vault?: string | null, _weight?: BigNumberish | null): TokenBoostedEmissionChangedEventFilter;
        'TokenWeightChanged(address,uint256)'(_token?: string | null, _weight?: BigNumberish | null): TokenWeightChangedEventFilter;
