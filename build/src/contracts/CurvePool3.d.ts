...
export interface CurvePool3Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'exchange_extended', values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish, boolean, string, string, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'commit_new_parameters', values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish, BigNumberish, BigNumberish, BigNumberish]): string;
...
export declare type ClaimAdminFeeEvent = TypedEvent<[string, BigNumber], {
    admin: string;
    tokens: BigNumber;
}>;
...
export interface CurvePool3 extends BaseContract {
    ...
    functions: {
        ...
        initialize(A: BigNumberish, gamma: BigNumberish, mid_fee: BigNumberish, out_fee: BigNumberish, allowed_extra_profit: BigNumberish, fee_gamma: BigNumberish, adjustment_step: BigNumberish, admin_fee: BigNumberish, ma_half_time: BigNumberish, initial_price: BigNumberish, _token: string, _coins: [string, string], _precisions: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        get_virtual_price(overrides?: CallOverrides): Promise<BigNumber>;
        price_oracle(overrides?: CallOverrides): Promise<BigNumber>;
        initialize(A: BigNumberish, gamma: BigNumberish, mid_fee: BigNumberish, out_fee: BigNumberish, allowed_extra_profit: BigNumberish, fee_gamma: BigNumberish, adjustment_step: BigNumberish, admin_fee: BigNumberish, ma_half_time: BigNumberish, initial_price: BigNumberish, _token: string, _coins: [string, string], _precisions: BigNumberish, overrides?: CallOverrides): Promise<void>;
        token(overrides?: CallOverrides): Promise<string>;
        coins(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
        price_scale(overrides?: CallOverrides): Promise<BigNumber>;
        last_prices(overrides?: CallOverrides): Promise<BigNumber>;
