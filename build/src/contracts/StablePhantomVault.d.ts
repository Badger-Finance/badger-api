...
export interface StablePhantomVaultInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'onExitPool', values: [BytesLike, string, string, BigNumberish[], BigNumberish, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: 'onJoinPool', values: [BytesLike, string, string, BigNumberish[], BigNumberish, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: 'onSwap', values: [IPoolSwapStructs.SwapRequestStruct, BigNumberish[], BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'queryExit', values: [BytesLike, string, string, BigNumberish[], BigNumberish, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: 'queryJoin', values: [BytesLike, string, string, BigNumberish[], BigNumberish, BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'startAmplificationParameterUpdate', values: [BigNumberish, BigNumberish]): string;
...
export declare type AmpUpdateStoppedEvent = TypedEvent<[BigNumber], {
...
export declare type CachedProtocolSwapFeePercentageUpdatedEventFilter = TypedEventFilter<CachedProtocolSwapFeePercentageUpdatedEvent>;
export declare type DueProtocolFeeIncreasedEvent = TypedEvent<[BigNumber], {
    bptAmount: BigNumber;
}>;
export declare type DueProtocolFeeIncreasedEventFilter = TypedEventFilter<DueProtocolFeeIncreasedEvent>;
export declare type PausedStateChangedEvent = TypedEvent<[boolean], {
    paused: boolean;
}>;
export declare type PausedStateChangedEventFilter = TypedEventFilter<PausedStateChangedEvent>;
export declare type SwapFeePercentageChangedEvent = TypedEvent<[BigNumber], {
    swapFeePercentage: BigNumber;
}>;
export declare type SwapFeePercentageChangedEventFilter = TypedEventFilter<SwapFeePercentageChangedEvent>;
export declare type TokenRateCacheUpdatedEvent = TypedEvent<[string, BigNumber], {
    token: string;
    rate: BigNumber;
}>;
...
export interface StablePhantomVault extends BaseContract {
    ...
    functions: {
        ...
        getTokenRateCache(token: string, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber
        ] & {
        ...
        'onSwap((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256[],uint256,uint256)'(swapRequest: IPoolSwapStructs.SwapRequestStruct, balances: BigNumberish[], indexIn: BigNumberish, indexOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        'onSwap((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256,uint256)'(arg0: IPoolSwapStructs.SwapRequestStruct, arg1: BigNumberish, arg2: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        setAssetManagerPoolConfig(token: string, poolConfig: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setTokenRateCacheDuration(token: string, duration: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        startAmplificationParameterUpdate(rawEndValue: BigNumberish, endTime: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        updateCachedProtocolSwapFeePercentage(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        updateTokenRateCache(token: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    DOMAIN_SEPARATOR(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        'onSwap((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256[],uint256,uint256)'(swapRequest: IPoolSwapStructs.SwapRequestStruct, balances: BigNumberish[], indexIn: BigNumberish, indexOut: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        'onSwap((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256,uint256)'(arg0: IPoolSwapStructs.SwapRequestStruct, arg1: BigNumberish, arg2: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        permit(owner: string, spender: string, value: BigNumberish, deadline: BigNumberish, v: BigNumberish, r: BytesLike, s: BytesLike, overrides?: CallOverrides): Promise<void>;
        queryExit(poolId: BytesLike, sender: string, recipient: string, balances: BigNumberish[], lastChangeBlock: BigNumberish, protocolSwapFeePercentage: BigNumberish, userData: BytesLike, overrides?: CallOverrides): Promise<[BigNumber, BigNumber[]] & {
            bptIn: BigNumber;
            amountsOut: BigNumber[];
        }>;
        queryJoin(poolId: BytesLike, sender: string, recipient: string, balances: BigNumberish[], lastChangeBlock: BigNumberish, protocolSwapFeePercentage: BigNumberish, userData: BytesLike, overrides?: CallOverrides): Promise<[BigNumber, BigNumber[]] & {
            bptOut: BigNumber;
            amountsIn: BigNumber[];
        }>;
        ...
        startAmplificationParameterUpdate(rawEndValue: BigNumberish, endTime: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        'CachedProtocolSwapFeePercentageUpdated(uint256)'(protocolSwapFeePercentage?: null): CachedProtocolSwapFeePercentageUpdatedEventFilter;
        CachedProtocolSwapFeePercentageUpdated(protocolSwapFeePercentage?: null): CachedProtocolSwapFeePercentageUpdatedEventFilter;
        ...
        'TokenRateProviderSet(address,address,uint256)'(token?: string | null, provider?: string | null, cacheDuration?: null): TokenRateProviderSetEventFilter;
        TokenRateProviderSet(token?: string | null, provider?: string | null, cacheDuration?: null): TokenRateProviderSetEventFilter;
    ...
    populateTransaction: {
        ...
        'onSwap((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256,uint256)'(arg0: IPoolSwapStructs.SwapRequestStruct, arg1: BigNumberish, arg2: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        permit(owner: string, spender: string, value: BigNumberish, deadline: BigNumberish, v: BigNumberish, r: BytesLike, s: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        queryExit(poolId: BytesLike, sender: string, recipient: string, balances: BigNumberish[], lastChangeBlock: BigNumberish, protocolSwapFeePercentage: BigNumberish, userData: BytesLike, overrides?: Overrides & {
