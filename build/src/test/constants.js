...
exports.MOCK_YIELD_SOURCES =
  exports.MOCK_VAULT_SNAPSHOT =
  exports.MOCK_VAULT_SNAPSHOTS =
  exports.MOCK_VAULT =
  exports.MOCK_VAULTS =
  exports.MOCK_VAULT_DEFINITION =
  exports.MOCK_BOUNCER_FILE =
  exports.MOCK_DISTRIBUTION_FILE =
  exports.TEST_CURRENT_TIMESTAMP =
  exports.TEST_ADDR =
    void 0;
const tslib_1 = require("tslib");
const sdk_1 = require("@badger-dao/sdk");
const loadVaultChart_json_1 = tslib_1.__importDefault(
  require("@badger-dao/sdk-mocks/generated/ethereum/api/loadVaultChart.json")
);
const loadVaults_json_1 = tslib_1.__importDefault(
  require("@badger-dao/sdk-mocks/generated/ethereum/api/loadVaults.json")
);
