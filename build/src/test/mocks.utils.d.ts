...
export declare function mockQueryResults(items: unknown[], filter?: (items: unknown[]) => unknown[]): jest.SpyInstance<QueryIterator<StringToAnyObjectMap>, [parameters: import("@aws/dynamodb-data-mapper").QueryParameters<StringToAnyObjectMap>]>;
