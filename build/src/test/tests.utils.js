...
exports.mockBadgerSdk =
  exports.mockChainVaults =
  exports.mockPricing =
  exports.setFullTokenDataMock =
  exports.setupMockAccounts =
  exports.randomCachedBoosts =
  exports.setupChainGasPrices =
  exports.randomSnapshots =
  exports.randomSnapshot =
  exports.randomValue =
  exports.defaultAccount =
  exports.setupDdbVaultsChartsData =
  exports.setupVaultsHistoricDDB =
  exports.setupVaultsCoumpoundDDB =
  exports.mockBatchDelete =
  exports.mockBatchPut =
  exports.setupBatchGet =
  exports.setupMapper =
  exports.mockVaultDTO =
  exports.CURRENT_BLOCK =
  exports.TEST_CHAIN =
    void 0;
...
function randomSnapshot(vaultDefinition) {
  const vault =
    vaultDefinition !== null && vaultDefinition !== void 0 ? vaultDefinition : constants_1.MOCK_VAULT_DEFINITION;
...
function setFullTokenDataMock() {
  ...
  jest
    .spyOn(tokens_service_1.TokensService.prototype, "loadTokens")
    .mockImplementation(async () => full_token_mock_1.fullTokenMockMap);
}
