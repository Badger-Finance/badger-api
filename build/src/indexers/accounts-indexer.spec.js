...
describe("accounts-indexer", () => {
  ...
  describe("refreshClaimableBalances", () => {
    ...
    it("looks up all user claimable balances on chains with rewards and persists them", async () => {
      ...
      let usersChecked;
      jest.spyOn(rewardsUtils, "getClaimableRewards").mockImplementation(async (_chain, chainUsers, _distribution) => {
      ...
      for (const acc of testAccounts) {
        expected.push(
          Object.assign(new user_claim_snapshot_model_1.UserClaimSnapshot(), {
