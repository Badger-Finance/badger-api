...
process.env.BADGER = 'https://api.thegraph.com/subgraphs/name/axejintao/badger-dao';
process.env.BADGER_BSC = 'https://api.thegraph.com/subgraphs/name/axejintao/badger-dao-bsc';
process.env.BADGER_DAO = 'https://api.thegraph.com/subgraphs/name/darruma/badger';
