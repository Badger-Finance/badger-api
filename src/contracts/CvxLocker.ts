...
export interface CvxLockerInterface extends utils.Interface {
  contractName: "CvxLocker";
  functions: {
...
export interface CvxLocker extends BaseContract {
  contractName: "CvxLocker";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CvxLockerInterface;
  ...
  functions: {
    ...
    claimableRewards(
      ...
      [CvxLockerV2.EarnedDataStructOutput[]] & {
        userRewards: CvxLockerV2.EarnedDataStructOutput[];
      }
    >;
    ...
    lockedBalances(
      ...
      [
        ...
        BigNumber,
        BigNumber,
        CvxLockerV2.LockedBalanceStructOutput[]
      ] & {
        total: BigNumber;
  ...
  claimableRewards(
    _account: string,
    overrides?: CallOverrides
  ): Promise<CvxLockerV2.EarnedDataStructOutput[]>;
