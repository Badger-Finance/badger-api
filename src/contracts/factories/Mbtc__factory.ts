...
import type { Mbtc, MbtcInterface } from '../Mbtc';
...
export class Mbtc__factory {
  static readonly abi = _abi;
  static createInterface(): MbtcInterface {
    return new utils.Interface(_abi) as MbtcInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Mbtc {
    return new Contract(address, _abi, signerOrProvider) as Mbtc;
  }
}
