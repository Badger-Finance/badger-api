...
import type { CvxBooster, CvxBoosterInterface } from '../CvxBooster';
...
export class CvxBooster__factory {
  ...
  static createInterface(): CvxBoosterInterface {
    return new utils.Interface(_abi) as CvxBoosterInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CvxBooster {
