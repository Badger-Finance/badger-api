...
interface CurvePoolV2Interface extends ethers.utils.Interface {
  functions: {
...
export type ClaimAdminFeeEvent = TypedEvent<[string, BigNumber] & { admin: string; tokens: BigNumber }>;

export class CurvePoolV2 extends BaseContract {
