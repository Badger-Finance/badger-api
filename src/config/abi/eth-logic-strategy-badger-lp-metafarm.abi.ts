export const contract = '0xB18D0bC54829bdFeAE998b8FE9a8df10953DcAeC';
export const abi = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'totalBadger', type: 'uint256' },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'totalBadger', type: 'uint256' },
        ...
        internalType: 'struct StrategyBadgerLpMetaFarm.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
