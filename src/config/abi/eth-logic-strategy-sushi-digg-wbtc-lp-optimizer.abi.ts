export const contract = '0x16626Fd20b8e1541Fdb85D9e63DEf368b374fa75';
export const abi = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'diggHarvested', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'diggConvertedToWbtc', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'wbtcFromConversion', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'lpGained', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'timestamp', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'blockNumber', type: 'uint256' },
    ],
    name: 'HarvestDiggState',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'xSushiHarvested', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'totalxSushi', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'toStrategist', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'toGovernance', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'toBadgerTree', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'timestamp', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'blockNumber', type: 'uint256' },
    ],
    name: 'HarvestState',
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'toWithdraw', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'preWant', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'postWant', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'uint256', name: 'diggHarvested', type: 'uint256' },
          { internalType: 'uint256', name: 'xSushiHarvested', type: 'uint256' },
          { internalType: 'uint256', name: 'totalxSushi', type: 'uint256' },
          { internalType: 'uint256', name: 'toStrategist', type: 'uint256' },
          { internalType: 'uint256', name: 'toGovernance', type: 'uint256' },
          { internalType: 'uint256', name: 'toBadgerTree', type: 'uint256' },
          { internalType: 'uint256', name: 'diggConvertedToWbtc', type: 'uint256' },
          { internalType: 'uint256', name: 'wbtcFromConversion', type: 'uint256' },
          { internalType: 'uint256', name: 'lpGained', type: 'uint256' },
        ],
        internalType: 'struct StrategySushiDiggWbtcLpOptimizer.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_keeper', type: 'address' },
      { internalType: 'address', name: '_guardian', type: 'address' },
      { internalType: 'address[4]', name: '_wantConfig', type: 'address[4]' },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [{ internalType: 'uint256', name: 'sushiTended', type: 'uint256' }],
        internalType: 'struct StrategySushiDiggWbtcLpOptimizer.TendData',
        name: '',
        type: 'tuple',
      },
    ],
