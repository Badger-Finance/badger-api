export const contract = '0xd0b1e9f652019B993dacdd97011557ec3b2B6019';
export const abi = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'sharesHarvested', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'diggToStrategist', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'diggToGovernance', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'sharesConvertedToWbtc', type: 'uint256' },
      ...
      { indexed: false, internalType: 'uint256', name: 'lpDeposited', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'lpGained', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'timestamp', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'blockNumber', type: 'uint256' },
    ],
    name: 'HarvestLpMetaFarm',
    type: 'event',
  },
  {
    anonymous: false,
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'sharesHarvested', type: 'uint256' },
          { internalType: 'uint256', name: 'diggToStrategist', type: 'uint256' },
          { internalType: 'uint256', name: 'diggToGovernance', type: 'uint256' },
          { internalType: 'uint256', name: 'sharesConvertedToWbtc', type: 'uint256' },
          { internalType: 'uint256', name: 'diggConvertedToWbtc', type: 'uint256' },
          { internalType: 'uint256', name: 'wbtcFromConversion', type: 'uint256' },
          { internalType: 'uint256', name: 'lpDeposited', type: 'uint256' },
          { internalType: 'uint256', name: 'lpGained', type: 'uint256' },
        ],
        internalType: 'struct StrategyDiggLpMetaFarm.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
