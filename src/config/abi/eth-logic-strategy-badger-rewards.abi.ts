export const contract = '0x38b9344fFB931ABA6476198095e088024CdAC527';
export const abi = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'uint256', name: 'wantIncrease', type: 'uint256' },
          { internalType: 'uint256', name: 'wantDeposited', type: 'uint256' },
        ],
        internalType: 'struct StrategyBadgerRewards.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
