export const contract = '0x752F5C9e91721dc7a7513106fbf249C46439A5EE';
export const abi = [
  {
    anonymous: false,
  ...
  {
    inputs: [{ internalType: 'address', name: '_approvedStaker', type: 'address' }],
    name: 'initializeApprovedStaker',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
