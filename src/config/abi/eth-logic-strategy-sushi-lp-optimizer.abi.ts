export const contract = '0x5435Fc74aeD67C81BB500490A4365AF5e6021bba';
export const abi = [
  {
    anonymous: false,
    inputs: [
    ...
    outputs: [
      {
        ...
        internalType: 'struct StrategySushiLpOptimizer.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'struct StrategySushiLpOptimizer.TendData',
        name: '',
        type: 'tuple',
      },
    ],
