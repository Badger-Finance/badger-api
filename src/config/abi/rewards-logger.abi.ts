export const rewardsLoggerAddress = '0x0A4F4e92C3334821EbB523324D09E321a6B0d8ec';
export const rewardsLoggerAbi = [
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'beneficiary', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'response', type: 'uint256' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'initialManager_', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
