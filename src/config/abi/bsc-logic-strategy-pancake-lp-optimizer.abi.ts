export const contract = '0x07c0e4f4c977a29c46fb26597ea8c9105ca50b42';
export const abi = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'cakeHarvested', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'cakeSold', type: 'uint256' },
      ...
      { indexed: false, internalType: 'uint256', name: 'wantCompounded', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'convertedToToken0', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'convertedToToken1', type: 'uint256' },
  ...
  },
  {
    inputs: [],
    name: 'chef',
    outputs: [{ internalType: 'contract IPancakeStaking', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'uint256', name: 'cakeHarvested', type: 'uint256' },
          { internalType: 'uint256', name: 'cakeSold', type: 'uint256' },
          { internalType: 'uint256', name: 'toStrategist', type: 'uint256' },
          { internalType: 'uint256', name: 'toGovernance', type: 'uint256' },
          { internalType: 'uint256', name: 'wantCompounded', type: 'uint256' },
        ],
        internalType: 'struct StrategyPancakeLpOptimizer.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_keeper', type: 'address' },
      { internalType: 'address', name: '_guardian', type: 'address' },
      { internalType: 'address[3]', name: '_wantConfig', type: 'address[3]' },
      { internalType: 'uint256[3]', name: '_feeConfig', type: 'uint256[3]' },
      { internalType: 'uint256', name: '_wantPid', type: 'uint256' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'setTokenSwapPath',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'uint256', name: '_wantPid', type: 'uint256' }],
    name: 'setWantPid',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      {
        components: [{ internalType: 'uint256', name: 'cakeTended', type: 'uint256' }],
        internalType: 'struct StrategyPancakeLpOptimizer.TendData',
        name: '',
        type: 'tuple',
      },
    ],
