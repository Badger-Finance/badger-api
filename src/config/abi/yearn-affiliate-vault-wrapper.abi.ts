export const yearnAffiliateVaultWrapperAbi = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'guestList', type: 'address' }],
  ...
  { inputs: [], name: 'acceptAffiliate', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'affiliate',
  ...
  },
  {
    inputs: [],
    name: 'guestList',
    outputs: [{ internalType: 'contract GuestListAPI', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'amount', type: 'uint256' },
      { internalType: 'uint256', name: 'maxMigrationLoss', type: 'uint256' },
    ],
    name: 'migrate',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [],
    name: 'registry',
    outputs: [{ internalType: 'contract RegistryAPI', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: '_guestList', type: 'address' }],
    name: 'setGuestList',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
