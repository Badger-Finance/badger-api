export const badgerTreeAbi = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'bytes32', name: 'root', type: 'bytes32' }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256[]', name: 'amountsToClaim', type: 'uint256[]' },
    ],
    name: 'claim',
    outputs: [],
    stateMutability: 'nonpayable',
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'publishBlock', type: 'uint256' },
          { internalType: 'uint256', name: 'startBlock', type: 'uint256' },
          { internalType: 'uint256', name: 'endBlock', type: 'uint256' },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'initialProposer', type: 'address' },
      { internalType: 'address', name: 'initialValidator', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
