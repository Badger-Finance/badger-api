export const contract = '0x066A817C19451C413a0638B82AfDA61ABf8E24A2';
export const abi = [
  {
    inputs: [
      { internalType: 'address', name: '_bdigg', type: 'address' },
      { internalType: 'address', name: '_memeLtd', type: 'address' },
  ...
  },
  {
    ...
    name: 'isolate',
    outputs: [
      { internalType: 'contract ERC20', name: 'bdigg', type: 'address' },
      { internalType: 'contract IMemeLtd', name: 'memeLtd', type: 'address' },
