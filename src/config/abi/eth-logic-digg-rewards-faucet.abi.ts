export const contract = '0xa42acbbee5796ad0862fd7340edc25f111cd10eb';
export const abi = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'reward', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'rewardInFragments', type: 'uint256' },
    ],
    name: 'RewardPaid',
    type: 'event',
  },
  ...
  },
  {
    inputs: [],
    name: 'digg',
    outputs: [{ internalType: 'contract IDigg', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_digg', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'rewardInShares', type: 'uint256' },
    ],
