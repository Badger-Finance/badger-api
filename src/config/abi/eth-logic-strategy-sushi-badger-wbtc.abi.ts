export const contract = '0x8D216AaBbdE01449dCb34c1e1365E558F614695c';
export const abi = [
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'badgerHarvested', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'badgerConvertedToWbtc', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'wtbcFromConversion', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'lpGained', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'timestamp', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'blockNumber', type: 'uint256' },
    ],
    name: 'HarvestBadgerState',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'uint256', name: 'badgerHarvested', type: 'uint256' },
          ...
          { internalType: 'uint256', name: 'badgerConvertedToWbtc', type: 'uint256' },
          { internalType: 'uint256', name: 'wtbcFromConversion', type: 'uint256' },
          { internalType: 'uint256', name: 'lpGained', type: 'uint256' },
        ],
        internalType: 'struct StrategySushiBadgerWbtc.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'struct StrategySushiBadgerWbtc.TendData',
        name: '',
        type: 'tuple',
      },
    ],
