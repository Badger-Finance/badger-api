export const contract = '0x17c118416BD713e00037125D85E58abaC60c4A4E';
export const abi = [
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'totalFarmHarvested', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'farmToRewards', type: 'uint256' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'farmTended', type: 'uint256' }],
    name: 'Tend',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'uint256', name: 'totalFarmHarvested', type: 'uint256' },
          { internalType: 'uint256', name: 'farmToRewards', type: 'uint256' },
        ...
        internalType: 'struct StrategyHarvestMetaFarm.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        components: [{ internalType: 'uint256', name: 'farmTended', type: 'uint256' }],
        internalType: 'struct StrategyHarvestMetaFarm.TendData',
        name: '',
        type: 'tuple',
      },
    ],
