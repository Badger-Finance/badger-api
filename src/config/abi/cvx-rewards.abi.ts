export const cvxRewardsAbi = [
  {
    inputs: [
      { internalType: 'address', name: 'stakingToken_', type: 'address' },
      { internalType: 'address', name: 'rewardToken_', type: 'address' },
      { internalType: 'address', name: 'crvDeposits_', type: 'address' },
      { internalType: 'address', name: 'cvxCrvRewards_', type: 'address' },
      { internalType: 'address', name: 'cvxCrvToken_', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'bool', name: '_stake', type: 'bool' }],
    name: 'getReward',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
