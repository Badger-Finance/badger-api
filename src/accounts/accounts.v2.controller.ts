...
export class AccountsV2Controller {
  ...
  @Description("Return key user information for a given account. Includes positions, earnings from use, and claimable balances.")
  @Returns(200, AccountModel)
  @Returns(400).Description("Not a valid chain")
  @Returns(404).Description("Not a valid account")
  async getAccount(@PathParams("accountId") userId: string, @QueryParams("chain") chain: Network): Promise<AccountModel> {
