    ...
    for (const chain of chain_1.SUPPORTED_CHAINS) {
        ...
        for (const vault of vaults) {
            try {
                ...
                const harvests = await (0, vaults_utils_1.getVaultHarvestsOnChain)(chain, vault.address, lastCompHarvest === null || lastCompHarvest === void 0 ? void 0 : lastCompHarvest.block);
