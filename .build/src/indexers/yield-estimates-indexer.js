            ...
            if (vault.version && vault.version === sdk_1.VaultVersion.v1_5) {
                try {
                    ...
                    if (now - sdk_1.ONE_DAY_MS / 3 > harvestData.lastReportedAt) {
                        (0, discord_utils_1.sendPlainTextToDiscord)(`${chain.network} ${vault.name} (${vault.protocol}, ${vault.version}, ${(_d = vault.state) !== null && _d !== void 0 ? _d : sdk_1.VaultState.Open}) failed to harvest!`);
