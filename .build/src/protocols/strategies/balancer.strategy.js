...
exports.getBalancerSwapFees = exports.resolveBalancerPoolTokenPrice = exports.getBalancerVaultTokenBalance = exports.getBalancerPoolTokens = exports.getBPTPrice = exports.BalancerStrategy = void 0;
...
async function getBalancerSwapFees(vault) {
    try {
        ...
        return [(0, yields_utils_1.createYieldSource)(vault, source_type_enum_1.SourceType.TradeFee, 'Balancer LP Fees', yearlyApr)];
    }
    catch {
