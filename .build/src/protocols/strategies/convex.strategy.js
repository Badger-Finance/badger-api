...
exports.resolveCurveStablePoolTokenPrice = exports.resolveCurvePoolTokenPrice = exports.getCurveVaultTokenBalance = exports.getCurvePoolBalance = exports.getCurveTokenPrice = exports.getCurvePerformance = exports.ConvexStrategy = exports.OLD_BRIBES_PROCESSOR = exports.BRIBES_PROCESSOR = exports.HARVEST_FORWARDER = exports.CURVE_BASE_REGISTRY = exports.CURVE_FACTORY_APY = exports.CURVE_ARBITRUM_API_URL = exports.CURVE_MATIC_API_URL = exports.CURVE_CRYPTO_API_URL = exports.CURVE_API_URL = void 0;
...
async function getCurvePerformance(chain, vaultDefinition) {
    ...
    async function updateFactoryApy(version) {
        if (!missingEntry()) {
            ...
            const poolDetails = factoryAPY.data.poolDetails.find((pool) => ethers_1.ethers.utils.getAddress(pool.poolAddress) === vaultDefinition.depositToken);
            if (poolDetails) {
    ...
    return (0, yields_utils_1.createYieldSource)(vaultDefinition, source_type_enum_1.SourceType.TradeFee, 'Curve LP Fees', tradeFeePerformance);
}
