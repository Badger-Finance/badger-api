...
exports.sendCodeBlockToDiscord = exports.sendPlainTextToDiscord = exports.sendMessageToDiscord = exports.sendErrorToDiscord = exports.VAULT_MANAGER_ROLE_ID = exports.BADGER_API_ROLE_ID = exports.SENTRY_NAME = void 0;
...
function sendErrorToDiscord(e, errorMsg, errorType) {
    var _a, _b;
    sendMessageToDiscord(`**${errorType}**`, `:x: ${errorMsg}`, [
        {
            name: 'Error Name',
            value: e.name,
            inline: true,
        ...
        {
            name: 'Error Stack',
            value: (_b = (_a = e.stack) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '',
            inline: false,
        },
    ], 'Error Bot');
}
