...
export declare type RecoveryModeStateChangedEvent = TypedEvent<[boolean], {
    enabled: boolean;
}>;
...
export interface StablePool extends BaseContract {
    ...
    functions: {
        ...
        'onSwap((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256,uint256)'(request: IPoolSwapStructs.SwapRequestStruct, balanceTokenIn: BigNumberish, balanceTokenOut: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        'onSwap((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256,uint256)'(request: IPoolSwapStructs.SwapRequestStruct, balanceTokenIn: BigNumberish, balanceTokenOut: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
