...
export interface CurveRegistryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'add_pool', values: [string, BigNumberish, string, BytesLike, BigNumberish, BigNumberish, boolean, boolean, string]): string;
    encodeFunctionData(functionFragment: 'add_pool_without_underlying', values: [string, BigNumberish, string, BytesLike, BigNumberish, BigNumberish, boolean, boolean, string]): string;
    encodeFunctionData(functionFragment: 'add_metapool', values: [string, BigNumberish, string, BigNumberish, string]): string;
...
export declare type PoolAddedEvent = TypedEvent<[string, string], {
    pool: string;
    rate_method_id: string;
}>;
export declare type PoolAddedEventFilter = TypedEventFilter<PoolAddedEvent>;
export declare type PoolRemovedEvent = TypedEvent<[string], {
    pool: string;
}>;
...
export interface CurveRegistry extends BaseContract {
    ...
    functions: {
        ...
        'find_pool_for_coins(address,address,uint256)'(_from: string, _to: string, i: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        ...
        get_parameters(_pool: string, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber,
            BigNumber,
        ...
        get_coin_indices(_pool: string, _from: string, _to: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, boolean]>;
        ...
        add_pool(_pool: string, _n_coins: BigNumberish, _lp_token: string, _rate_info: BytesLike, _decimals: BigNumberish, _underlying_decimals: BigNumberish, _has_initial_A: boolean, _is_v1: boolean, _name: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        add_pool_without_underlying(_pool: string, _n_coins: BigNumberish, _lp_token: string, _rate_info: BytesLike, _decimals: BigNumberish, _use_rates: BigNumberish, _has_initial_A: boolean, _is_v1: boolean, _name: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        'add_metapool(address,uint256,address,uint256,string)'(_pool: string, _n_coins: BigNumberish, _lp_token: string, _decimals: BigNumberish, _name: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        'add_metapool(address,uint256,address,uint256,string,address)'(_pool: string, _n_coins: BigNumberish, _lp_token: string, _decimals: BigNumberish, _name: string, _base_pool: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        remove_pool(_pool: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        set_pool_gas_estimates(_addr: [string, string, string, string, string], _amount: [
            [
                BigNumberish,
                BigNumberish
            ],
        ...
        set_coin_gas_estimates(_addr: string[], _amount: BigNumberish[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        set_gas_estimate_contract(_pool: string, _estimator: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        set_liquidity_gauges(_pool: string, _liquidity_gauges: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        set_pool_asset_type(_pool: string, _asset_type: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        batch_set_pool_asset_type(_pools: string[], _asset_types: BigNumberish[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        get_coin_swap_complement(_coin: string, _index: BigNumberish, overrides?: CallOverrides): Promise<string>;
        get_pool_asset_type(_pool: string, overrides?: CallOverrides): Promise<BigNumber>;
        add_pool(_pool: string, _n_coins: BigNumberish, _lp_token: string, _rate_info: BytesLike, _decimals: BigNumberish, _underlying_decimals: BigNumberish, _has_initial_A: boolean, _is_v1: boolean, _name: string, overrides?: CallOverrides): Promise<void>;
        add_pool_without_underlying(_pool: string, _n_coins: BigNumberish, _lp_token: string, _rate_info: BytesLike, _decimals: BigNumberish, _use_rates: BigNumberish, _has_initial_A: boolean, _is_v1: boolean, _name: string, overrides?: CallOverrides): Promise<void>;
        'add_metapool(address,uint256,address,uint256,string)'(_pool: string, _n_coins: BigNumberish, _lp_token: string, _decimals: BigNumberish, _name: string, overrides?: CallOverrides): Promise<void>;
        'add_metapool(address,uint256,address,uint256,string,address)'(_pool: string, _n_coins: BigNumberish, _lp_token: string, _decimals: BigNumberish, _name: string, _base_pool: string, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        'find_pool_for_coins(address,address,uint256)'(_from: string, _to: string, i: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        'find_pool_for_coins(address,address)'(_from: string, _to: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        'find_pool_for_coins(address,address,uint256)'(_from: string, _to: string, i: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        get_coin_indices(_pool: string, _from: string, _to: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        estimate_gas_used(_pool: string, _from: string, _to: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        get_coin_swap_complement(_coin: string, _index: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
