...
export declare type CommitNewAdminEvent = TypedEvent<[BigNumber, string], {
    deadline: BigNumber;
    admin: string;
}>;
...
export interface CurveBaseRegistry extends BaseContract {
    ...
    functions: {
        ...
        add_new_id(_address: string, _description: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        set_address(_id: BigNumberish, _address: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        unset_address(_id: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        commit_transfer_ownership(_new_admin: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        get_id_info(arg0: BigNumberish, overrides?: CallOverrides): Promise<[
            string,
            boolean,
            BigNumber,
            BigNumber,
    ...
    filters: {
        'NewAddressIdentifier(uint256,address,string)'(id?: BigNumberish | null, addr?: null, description?: null): NewAddressIdentifierEventFilter;
        NewAddressIdentifier(id?: BigNumberish | null, addr?: null, description?: null): NewAddressIdentifierEventFilter;
        'AddressModified(uint256,address,uint256)'(id?: BigNumberish | null, new_address?: null, version?: null): AddressModifiedEventFilter;
