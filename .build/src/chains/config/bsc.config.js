...
class BinanceSmartChain extends chain_config_1.Chain {
    constructor() {
        super(sdk_1.Network.BinanceSmartChain, bsc_tokens_config_1.bscTokensConfig, rpc_config_1.default[sdk_1.Network.BinanceSmartChain], new base_strategy_1.BaseStrategy(sdk_1.Network.BinanceSmartChain, Object.keys(bsc_tokens_config_1.bscTokensConfig)));
