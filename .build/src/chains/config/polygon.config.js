...
class Polygon extends chain_config_1.Chain {
    constructor() {
        super(sdk_1.Network.Polygon, polygon_tokens_config_1.maticTokensConfig, rpc_config_1.default[sdk_1.Network.Polygon], new base_strategy_1.BaseStrategy(sdk_1.Network.Polygon, Object.keys(polygon_tokens_config_1.maticTokensConfig)));
