...
let PriceController = class PriceController {
  async listPrices(tokens, chain, currency) {
    ...
    return this.pricesService.getPriceSummary(
      (_a = tokens === null || tokens === void 0 ? void 0 : tokens.split(",")) !== null && _a !== void 0
        ? _a
        : Object.keys(chain_config_1.Chain.getChain(chain).tokens),
      currency
    );
  }
...
tslib_1.__decorate(
  [(0, common_1.Inject)(), tslib_1.__metadata("design:type", prices_service_1.PricesService)],
  PriceController.prototype,
  "pricesService",
  void 0
);
tslib_1.__decorate(
...
PriceController = tslib_1.__decorate([(0, common_1.Controller)("/prices")], PriceController);
