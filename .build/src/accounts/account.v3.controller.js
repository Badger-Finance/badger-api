...
tslib_1.__decorate([
    (0, common_1.Inject)(),
    tslib_1.__metadata("design:type", accounts_service_1.AccountsService)
], AccountV3Controller.prototype, "accountsService", void 0);
tslib_1.__decorate([
    (0, common_1.Get)(),
    (0, schema_1.ContentType)('json'),
    (0, schema_1.Summary)('Get badger user account information'),
    (0, schema_1.Description)('Return key user information for a given account. Includes positions, earnings from use, and claimable balances.'),
...
], AccountV3Controller.prototype, "getAccount", null);
AccountV3Controller = tslib_1.__decorate([
