...
exports.createYieldSource =
  exports.getVaultYieldProjection =
  exports.getYieldSources =
  exports.calculateBalanceDifference =
  exports.calculateYield =
  exports.aggregateSources =
    void 0;
...
function isNonHarvestSource(source) {
  return (
    source.type !== source_type_enum_1.SourceType.Compound &&
