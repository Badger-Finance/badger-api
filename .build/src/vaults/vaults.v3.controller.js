...
let VaultsV3Controller = class VaultsV3Controller {
  ...
  async getVaultsHarvests(vault, chain) {
    if (!vault) throw new query_param_error_1.QueryParamError("vault");
...
tslib_1.__decorate(
  [(0, common_1.Inject)(), tslib_1.__metadata("design:type", vaults_service_1.VaultsService)],
  VaultsV3Controller.prototype,
  "vaultService",
  void 0
);
tslib_1.__decorate(
...
tslib_1.__decorate(
  ...
  VaultsV3Controller.prototype,
  "getVaultSnapshotsInRange",
  null
);
VaultsV3Controller = tslib_1.__decorate([(0, common_1.Controller)("/vaults")], VaultsV3Controller);
