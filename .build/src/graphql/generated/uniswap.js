...
(function (LiquidityPositionSnapshot_OrderBy) {
  ...
  (LiquidityPositionSnapshot_OrderBy =
    exports.LiquidityPositionSnapshot_OrderBy || (exports.LiquidityPositionSnapshot_OrderBy = {}))
);
...
function getSdk(client, withWrapper = defaultWrapper) {
  return {
    UniPairDayDatas(variables, requestHeaders) {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request(exports.UniPairDayDatasDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders
          }),
        "UniPairDayDatas",
    ...
    UniV2Pair(variables, requestHeaders) {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request(exports.UniV2PairDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
        "UniV2Pair",
        "query"
      );
    }
