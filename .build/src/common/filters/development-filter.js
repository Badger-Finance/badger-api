...
let DevelopmentFilter = class DevelopmentFilter {
  use(_) {
    if (constants_1.PRODUCTION) throw new access_denied_dev_error_1.AccessDeniedDevError();
  }
};
tslib_1.__decorate(
  [
  ...
  DevelopmentFilter.prototype,
  "use",
  null
);
DevelopmentFilter = tslib_1.__decorate([(0, platform_middlewares_1.Middleware)()], DevelopmentFilter);
