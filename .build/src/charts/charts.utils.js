...
exports.queryVaultCharts =
  exports.updateSnapshots =
  exports.shouldTrim =
  exports.shouldUpdate =
  exports.toChartDataKey =
  exports.toChartDataBlob =
  exports.CHART_GRANULARITY_TIMEFRAMES =
    void 0;
...
async function queryVaultCharts(id) {
  try {
    ...
    for await (const item of mapper.query(
      chart_data_blob_model_1.ChartDataBlob,
      { id },
